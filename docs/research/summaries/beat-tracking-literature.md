...
| Mottaghi et al. (2017), "OBTAIN: Real-Time Beat Tracking in Audio Signals" | **Verified fallback** | arXiv source found. Uses onset strength, tempo estimation, cumulative beat strength, and peak selection for online beat tracking. |
...
current analysis against any Dixon/Laroche/OBTAIN-inspired changes. The immediate implementation
value is stronger tests and diagnostics, not a new algorithm.
